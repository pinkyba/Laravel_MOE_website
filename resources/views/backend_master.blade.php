...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="#">MOE Admin</a>
          ...
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li>
              <a class="dropdown-item" href="{{route('logout')}}" onclick="event.preventDefault();
                                       document.getElementById('logout-form').submit();" style="font-size: 13px !important;"><i class="fa fa-sign-out fa-lg"></i> Logout</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
        <div>
          <p class="app-sidebar__user-name">John</p>
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{Request::is('courses*')? 'active':''}}" href="{{route('courses.index')}}"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Courses</span></a></li>
        <li><a class="app-menu__item" href=""><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Books</span></a></li>
